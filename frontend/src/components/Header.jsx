...
export default function Header() {
  ...
  const defaultCategories = React.useMemo(() => [
    { name: "Home", link: "/", icon: "/images/Icon/menu-icons/Essential/home.png" },
    {
      ...
      sub: [
        { name: "Gold Wedding", link: "/gold/wedding" },
        { name: "Gold Traditional ", link: "/gold/traditional" },
        { name: "Gold rajasthani collection  ", link: "/gold/rajasthani" },
        { name: "Rose gold collection", link: "/gold/rose-gold" },
        { name: "Diamond Wedding collection ", link: "/diamond/wedding" },
        ...
        { name: "Gift Collection", link: "/silver/gift" },
      ],
    },
    {
